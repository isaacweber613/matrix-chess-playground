class ChessGame {
    ...
    async showHint() {
        if (this.gameStatus !== 'playing' || this.isThinking) {
            return;
        }
    ...
    handleSquareClick(event) {
        if (this.gameStatus !== 'playing' || this.isThinking) return;
        ...
        if (this.selectedSquare) {
            ...
            if (this.isValidMove(this.selectedSquare.row, this.selectedSquare.col, row, col)) {
                ...
                if (this.gameMode === 'human-vs-bot' && this.gameStatus === 'playing') {
                    setTimeout(() => this.makeBotMove(), 500);
                }
            } else {
                this.clearSelection();
    ...
    async makeBotMove() {
        ...
        if (this.gameMode === 'bot-vs-bot' && this.gameStatus === 'playing') {
